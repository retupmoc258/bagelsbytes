<template>
    <!-- Hero Start -->
    <section class="bg-half-130 d-table w-100 bg-light" :style="{ 'background-image': 'url(' + (image) + ')', backgroundPosition: 'center' }">
        <div class="container">
                                ...
                                <div class="row">
                                    ...
                                    <div class="mx-auto">
                                        <p class="mb-0 mt-3"><small class="text-dark me-2">Already have an account
                                                ?</small> <router-link to="/login" class="text-dark fw-bold">Sign
                                                in</router-link></p>
                                    </div>
                                </div>
                            </form>
