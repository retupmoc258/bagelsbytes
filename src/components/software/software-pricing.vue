                ...
                <div class="row align-items-center">
                    <div class="col-md-6 col-12">
                        <div class="card pricing border-0 p-4 rounded-md shadow">
                            <div class="card-body p-0">
                                ...
                                <h1 class="fw-bold mb-0 mt-3">$16.00</h1>
                                <p class="text-muted small">For personal projects</p>

                                <ul class="list-unstyled">
                                    <li class="text-muted mb-0"><span class="text-primary h5 me-2"><i
                                                class="uil uil-user-check"></i></span>Full Access</li>
                                    <li class="text-muted mb-0"><span class="text-primary h5 me-2"><i
                                                class="uil uil-file"></i></span>Source Files</li>
                                    <li class="text-muted mb-0"><span class="text-primary h5 me-2"><i
                                                class="uil uil-server"></i></span>1 Domain Free</li>
                                    <!-- <li class="text-muted mb-0"><span class="text-primary h5 me-2"><i class="uil uil-shield-plus"></i></span>Enhanced Security</li> -->
                                </ul>

                                <div class="mt-4">
                                    <div class="d-grid">
                                        <a href="javascript:void(0)" class="btn btn-primary">Create your account</a>
                                    </div>
                    ...
                    <div class="col-md-6 col-12 mt-4 mt-sm-0 pt-2 pt-sm-0">
                        <div class="card pricing border-0 p-4 rounded-md shadow bg-dark bg-white-dark">
                            <div class="card-body p-0">
                                <span
                                    class="py-2 px-4 d-inline-block bg-soft-success h6 mb-0 text-success rounded-lg">Business</span>
                                <h1 class="fw-bold text-white title-dark mb-0 mt-3">$45.00</h1>
                                <p class="text-white-50 small">30-Day free trial</p>

                                <ul class="list-unstyled">
                                    <li class="text-light para-dark mb-0"><span class="text-success h5 me-2"><i
                                                class="uil uil-user-check"></i></span>Full Access</li>
                                    <li class="text-light para-dark mb-0"><span class="text-success h5 me-2"><i
                                                class="uil uil-file"></i></span>Source Files</li>
                                    <li class="text-light para-dark mb-0"><span class="text-success h5 me-2"><i
                                                class="uil uil-server"></i></span>1 Domain Free</li>
                                    <li class="text-light para-dark mb-0"><span class="text-success h5 me-2"><i
                                                class="uil uil-shield-plus"></i></span>Enhanced Security</li>
                                </ul>

                                <div class="mt-4">
                                    <div class="d-grid">
                                        <a href="javascript:void(0)" class="btn btn-soft-success">Create your
                                            account</a>
                                    </div>
